    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          <h1 className="text-3xl sm:text-white text-gradient py-1">
          ...
          <button type="button" onClick={connectWallet} className="flex justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10 gap-2">
            ...
            <div className={commonStyle}>Blockchain</div>
            <div className={`rounded-br-2xl ${commonStyle}`}>Low fees</div>
          </div>
        </div>
